...
public class PrimePBInstrumentImpl implements IInstrument {
	
	private String prefix = "PRIME_PB_";
	...
	public PrimePBInstrumentImpl(String suffix,String lastTradingDate,String deliveryDate,String market,String label,String tradable) {
